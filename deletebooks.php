...
<head>
    ...
    <div class="container">
        ...
        <div class="content">
            <form action = "removebooks.php" class = "book-form" method = "post">
                <div class="head">
                    <h1>Delete Books</h1>
                    <p>Delete books in the database by ISBN</p>
                    <hr>
                </div>
                ...
                <div class="form-element">
                    <label for="delete"><b>ISBN</b></label>
                    <input type="text" placeholder="Enter ISBN for the Book" name="delete" id="delete" maxlength="30" required>
                </div>
                
                <div class="form-element">
                    <button type="submit" class="submitbtn" name = "submit">Delete</button>
